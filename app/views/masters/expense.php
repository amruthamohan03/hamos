<div class="page-content">
    ...
    foreach ($types as $t): ?>
                    ...
                    <div class="card-body">
                        <h4 class="header-title">Expense Type List</h4>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="mb-2">
                        ...
                        <input type="text" name="expense_type_name" id="edit_expense_type_name" class="form-control"
                            required>
                    </div>
                    <div class="col-md-6 mb-3">
    <label>Type</label><br>
    ...
    $.ajax({
        ...
        success: function(res) {
            ...
            if (res.success) {
                ...
                typeList.forEach(t => {
                    if (data[t] == 1) {
                        $('#type_' + t).prop('checked', true);  // FIXED
                    }
                });
                ...
                alert('Expense Type not found');
            }
        },
        error: function() {
            alert('Error fetching Expense Type data.');
        }
    });
});
